...
class SendAppointmentReminderEmail implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Mail::to($this->appointment->email)->send(new AppointmentReminderEmail());
        Mail::to('secretary@mail.com')->send(new AppointmentReminderEmail());
        Mail::to('lawyer@mail.com')->send(new AppointmentReminderEmail());
    }
}
